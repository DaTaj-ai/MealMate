...
public class SearchFragment extends Fragment implements ISearchFragmentUI {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        SearchFragmentPresenter presenter = new SearchFragmentPresenter(this, RepositoryImpl.getInstance(MealRemoteDataSourceImpl.getInstance(), MealLocalDataSourceImpl.getInstance(getContext())));

        // get  meals
        Observable<ListMealDto> mealsObservable = presenter.searchMeals("a");
                ...
                Observer listAreaDtoObserver = new Observer<ListAreaDto>() {
                    ...
                    public void onNext(@io.reactivex.rxjava3.annotations.NonNull ListAreaDto listAreaDto) {
                        ...
                        if (countryGroup != null && listAreaDto != null) {
                            populateChipGroup(countryGroup, listAreaDto.toList());
                        }
        ...
        Observable<String> searchQueryObservable = Observable.create(emitter -> {
            searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                ...
                public boolean onQueryTextChange(String newText) {
                    emitter.onNext(newText); // Emit the query text
                    return false;
                }
            });
